...
func TestController_updateNodeGeometry_createsPlanForPendingPodRequest(t *testing.T) {
	...
	updated, err := controller.updateNodeGeometry(ctx, *node, requested)
	...
	expectedSpec := map[string]string{
	...
	for key, value := range expectedSpec {
